...
<head>
    ...
    <script type="text/javascript" src="{{ asset('assets/js/toastr.mi')}}n.js"></script>
...
<body>
        ...
        <section class="content-central">
                ...
                <div>
                    <div class="container">
                        ...
                        <div class="portfolioContainer" style="margin-top: -50px;">
                            ...
                            <a class="g-list" href="{{ asset('service-details/ac-dry-servicing.html')}}">
                                <div class="img-hover">
                                ...
                                <div class="info-gallery">
                                    ...
                                    <div class="content-btn"><a href="{{ asset('service-details/ac-dry-servicing.htm')}}l"
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                    style="padding-right: 5px;padding-left: 5px;">
                                    <a class="g-list" href="{{asset('service-details/ac-installation.html')}}">
                                <div class="img-hover">
                                ...
                                <div class="info-gallery">
                                    ...
                                    <hr class="separator">
                                    <p>AC Installation</p>
                                    <div class="content-btn"><a href="{{asset('service-details/ac-installation.html')}}"
                                        class="btn btn-primary">Book Now</a></div>
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                            style="padding-right: 5px;padding-left: 5px;">
                            <a class="g-list" href="{{asset('service-details/ac-gas-top-up.html')}}">
                                <div class="img-hover">
                                ...
                                <div class="info-gallery">
                                    ...
                                    <hr class="separator">
                                    <p>AC Gas Top Up</p>
                                    <div class="content-btn"><a href="{{asset('service-details/ac-gas-top-up.html')}}"
                                        class="btn btn-primary">Book Now</a></div>
                                        <div class="price"><span>&#36;</span><b>From</b>320</div>
                                    </div>
                                    </a>
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                            style="padding-right: 5px;padding-left: 5px;">
                            <a class="g-list" href="{{ asset('service-details/ac-gas-refill.html')}}">
                                <div class="img-hover">
                                ...
                                <div class="info-gallery">
                                        ...
                                        <hr class="separator">
                                        <p>AC Gas Refill</p>
                                        <div class="content-btn"><a href="{{ asset('service-details/ac-gas-refill.html')}}"
                                            class="btn btn-primary">Book Now</a></div>
            ...
            <div>
                ...
                <div id="boxes-carousel">
                    <div>
                        <a class="g-list" href="{{ asset('service-details/ac-wet-servicing.html')}}">
                            <div class="img-hover">
                            ...
                            <div class="info-gallery">
                                ...
                                <div class="content-btn"><a href="{{ asset('service-details/ac-wet-servicing.html')}}"
                                    class="btn btn-primary">Book Now</a></div>
                        ...
                        <div>
                            <a class="g-list" href="service-details/bedroom-deep-cleaning.html">
                                ...
                                <div class="info-gallery">
                                    ...
                                    <div class="content-btn"><a href="{{ asset('service-details/bedroom-deep-cleaning.html')}}"
                                        class="btn btn-primary">Book Now</a></div>
                                        <div class="price"><span>&#36;</span><b>From</b>300</div>
                                    </div>
                                </a>
                            ...
                            <div>
                                <a class="g-list" href="service-details/dining-chair-shampooing.html">
                                    ...
                                    <div class="info-gallery">
                                        ...
                                        <div class="content-btn"><a href="{{ asset('service-details/dining-chair-shampooing.html')}}"
                                        class="btn btn-primary">Book Now</a></div>
                        ...
                        <div>
                            ...
                            <div class="info-gallery">
                                ...
                                <div class="content-btn"><a href="{{ asset('service-details/carpet-shampooing.html')}}"
                                        class="btn btn-primary">Book Now</a></div>
                                        <div class="price"><span>&#36;</span><b>From</b>200</div>
                                    </div>
                        </a>
                    ...
                    <div>
                        <a class="g-list" href="service-details/fabric-sofa-shampooing.html">
                            ...
                            <div class="info-gallery">
                                ...
                                <div class="content-btn"><a href="{{ asset('service-details/fabric-sofa-shampooing.html')}}"
                                    class="btn btn-primary">Book Now</a></div>
                    ...
                    <div>
                        <a class="g-list" href="service-details/bathroom-deep-cleaning.html">
                            ...
                            <div class="info-gallery">
                                ...
                                <div class="content-btn"><a href="{{ asset('service-details/bathroom-deep-cleaning.html')}}"
                                    class="btn btn-primary">Book Now</a></div>
                        ...
                        <a class="g-list" href="service-details/floor-scrubbing-polishing.html">
                            ...
                            <div class="info-gallery">
                                ...
                                <div class="content-btn"><a href="{{ asset('service-details/floor-scrubbing-polishing.html')}}"
                                    class="btn btn-primary">Book Now</a></div>
                        ...
                        <div>
                            <a class="g-list" href="service-details/mattress-shampooing.html">
                                ...
                                <div class="info-gallery">
                                    ...
                                    <div class="content-btn"><a href="{{ asset('service-details/mattress-shampooing.html')}}"
                                        class="btn btn-primary">Book Now</a></div>
                            ...
                            <div>
                                <a class="g-list" href="service-details/kitchen-deep-cleaning.html">
                                    ...
                                    <div class="content-btn"><a href="{{ asset('service-details/kitchen-deep-cleaning.html')}}"
                                        class="btn btn-primary">Book Now</a></div>
                        ...
                        <ul>
                            <li><i class="fa fa-check"></i> <a
                                ...
                                <li><i class="fa fa-check"></i> <a
                                    ...
                                    <li><i class="fa fa-check"></i> <a href="{{ asset('service-details/ac-wet-servicing.html')}}">We')}}t
                                Servicing</a></li>
                                <li><i class="fa fa-check"></i> <a href="{{ asset('service-details/ac-dry-servicing.html')}}">Dr')}}y
                                    Servicing </a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/20.htm')}}l">Painting </a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        <h3>CONTACT US</h3>
    ...
    <script type="text/javascript" src="{{ asset('assets/js/nav/jquery.sticky')}}"></script>
