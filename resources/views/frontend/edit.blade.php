    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header d-flex">
                <b>Update Post {{ $post->user->name }}</b>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('post.update',$post->id) }}" method="POST" enctype="multipart/form-data">
                  ...
                  @if ($post->image !='')
                  <div class="form-groub">
                      <img src="{{ asset('assets/image/'.$post->image) }} " alt="{{ $post->title }}"  width="100">
                    </div>
                  @endif
                  ...
                  <div class="text-center">
                   <input type="submit" class="btn btn-success" name="save" value="Update Post">
                </div>
